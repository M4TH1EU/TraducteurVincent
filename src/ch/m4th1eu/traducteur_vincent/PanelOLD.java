...
public class PanelOLD extends JPanel implements SwingerEventListener {
    private static Saver saver;
    private static File DIR = new File("C:" + "\\" + "Users" + "\\" + System.getenv("USERNAME") + "\\" + "Documents");

    static {
        PanelOLD.saver = new Saver(new File(DIR, "\\latest.txt"));
    }
    ...
    private JTextArea texte_crypt = new JTextArea("Texte crypté");
    ...
    public PanelOLD() {
        ...
        convert_button.addActionListener(e -> {
            getCrypt();
            //System.out.println("Fichier de décryptage téléchargé.");
            try {
                unCrypt();
    ...
    public void getCrypt() {
        try (BufferedInputStream inputStream = new BufferedInputStream(new URL("https://mathieubroillet.ch/brandons/crypt.txt").
             ...
             FileOutputStream fileOS = new FileOutputStream("C:/Users/broil/Documents/crypt.txt")) {
    ...
    public void unCrypt() throws IOException {
        System.out.println(fr_to_crypt);
        if (fr_to_crypt) {
            BufferedReader bufferedReader_fr = new BufferedReader(new FileReader("C:/Users/broil/Documents/test.txt"));
            String str1;
            ...
            System.out.println("LAW" + " / " + fr_to_crypt);
            BufferedReader bufferedReader_crypt = new BufferedReader(new FileReader("C:/Users/broil/Documents/test1.txt"));
            String str2;
        ...
        /*String line1 = lines.get(0).replaceAll("B", "B2");
